...
data.sorted_keys = lambda reverse: sorted(data.keys(), reverse=reverse)
data.sorted_values = lambda reverse: sorted(data.values(), reverse=reverse)

print(data.sorted_values(reverse=True))
print(data.sorted_keys(reverse=False))
