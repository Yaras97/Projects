...
квадратов всех двузначных чисел из данного списка, которые делятся на 99 без остатка.

Примечание 1. Обратите внимание, на 99 должно делиться само число, а не его квадрат.
...
print(sum(list(map(lambda x: x**2, filter(lambda x: len(str(abs(x))) == 2 and x % 99 == 0, numbers)))))
